...
<p align = 'justify'>Here we used 97 training example to train the model, and used Batch Gradient Descent as Otimizer over 5000 iteration to get optimized theta(paramer/weight).</p>
